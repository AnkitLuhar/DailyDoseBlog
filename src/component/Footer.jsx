      ...
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4">
        <div className="grid mb-8 lg:grid-cols-6">
          <div className="grid grid-cols-2  gap-5 lg:col-span-4 md:grid-cols-4">
            ...
            {/* {second} */}
            <div>
              <p className="font-medium text-gray-300 tracking-wide">Apples</p>
              <ul className="mt-2 space-y-2">
                <li>
                  <a
                    href="/"
          ...
          <div className="md:max-w-md lg:col-span-2 lg:mt-0 mt-5">
            ...
            <form className="mt-4  flex flex-col md:flex-row">
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center h-12 px-6 font-medium text-white tracking-wide transition duration-200 rounded shadow-md hover:bg-orange-500 focus:outline-none border"
              >
                Subscribe
              </button>
            </form>
